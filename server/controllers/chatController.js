...
module.exports.accessChat = asyncHandler(async (req, res) => {
  ...
  var isChat = await Chat.find({
    ...
    .populate("users", "-password -isAvatarImageSet -__v")
...
module.exports.updateGroupChat = asyncHandler(async (req, res) => {
...
module.exports.renameGroupChat = asyncHandler(async (req, res) => {
...
module.exports.deleteGroupChat = asyncHandler(async (req, res) => {
  try {
    const deleted = await Chat.findOneAndRemove({
